...
class ExamplarController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('Examplar');
	...
	{
		$model=new Examplar('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Examplar']))
			$model->attributes=$_GET['Examplar'];
	 ...
	 * @return Examplar the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=Examplar::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Examplar $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='examplar-form')
		{
