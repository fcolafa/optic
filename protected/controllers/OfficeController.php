...
class OfficeController extends Controller
{
	...
	public function accessRules()
	{
			...
			array('allow', // allow admin user to perform 'admin' and 'delete' actions
				'actions'=>array('index','view','create','update','admin','delete','fillcity'),
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Office']))
		{
			$model->attributes=$_POST['Office'];
                        $model->office_name=ucwords(strtolower($model->office_name));
                        $model->office_address=ucwords(strtolower($model->office_address));
			if($model->save())
	...
	public function actionIndex($id=NULL)
	{
		$dataProvider=new CActiveDataProvider('Office');
                if($id!=NULL)
                $dataProvider=new CActiveDataProvider('Office',array(
                      'criteria'=>array(
                          'condition'=>'id_city='.$id,
                       )));
	...
	protected function performAjaxValidation($model)
	{
        ...
        public function actionFillcity() {
            $id=$_POST['Office']['id_zone'];
            echo $id;
            $lista= City::model()->findAll('id_zone=:id_zone',array(':id_zone'=>$id));
            $lista=CHtml::listData($lista,'id_city','city_name');
            echo CHtml::tag('option',array('empty'),CHtml::encode(Yii::t('actions','Select')." ".Yii::t('database','City')),true);
