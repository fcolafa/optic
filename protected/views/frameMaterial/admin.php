...
$this->breadcrumbs=array(
	Yii::t('database',Yii::t('database','Frame Materials'))=>array('index'),
...
$('.search-form form').submit(function(){
	$('#frame-material-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
...
<h1><?php echo Yii::t('actions','Manage')?> <?php echo Yii::t('database','Frame Materials')?></h1>
